...
COINS: dict[str, dict[str, Any]] = {
    ...
    "PRL": {
        ...
        "pool": ("pearlpow.unmineable.com", "4444"),
        "solo": ("solo-prl.2miners.com", "1919"),
        "pool_login": "{address}.Aura",
        "solo_login": "{address}.Aura",
        "password": "x",
        "coingecko": "pearl-2",
        "coinbase": None,
        "wtm_tag": "PRL",
        "pool_stats": "unmineable",
        "pool_api": "",
        "pool_miner": "unMineable / 2Miners solo",
        "pool_blocks": True,
        "note": "Pool: pearlpow.unmineable.com:4444 (SSL, BTC payout OK). Solo: solo-prl.2miners.com:1919 (treba prl1... adresa).",
    },
}
